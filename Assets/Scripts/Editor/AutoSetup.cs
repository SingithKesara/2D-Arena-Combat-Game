...
public class AutoSetup : EditorWindow
{
    ...
    private static void BuildHUD(GameStateManager gsm, HealthManager hmP1, HealthManager hmP2)
    {
        ...
        TextMeshProUGUI announcementText = CreateTMP(canvasGO.transform, "AnnouncementText", "", new Vector2(1100f, 140f), 72f, Color.yellow, TextAlignmentOptions.Center);
        ...
        out TextMeshProUGUI scoreText)
    {
        ...
        TextMeshProUGUI nameText = CreateTMP(nameGO.transform, "Label", isLeft ? "PLAYER 1" : "PLAYER 2", new Vector2(220f, 28f), 22f,
        ...
        hpText = CreateTMP(barGO.transform, "HPText", "100", new Vector2(80f, 28f), 18f, Color.white,
